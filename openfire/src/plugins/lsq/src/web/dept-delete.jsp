<%--
  -	$RCSfile$
  -	$Revision: 11592 $
  -	$Date: 2010-02-01 09:46:59 -0600 (Mon, 01 Feb 2010) $
  -
...
<%  // Get parameters //
    ...
    if (delete) {
        ...
        // Done, so redirect
        response.sendRedirect("dept-summary.jsp?deletesuccess=true");
        return;
    }
%>
...
<html>
    <head>
        ...
        <meta name="subPageID" content="dept-delete"/>
...
<b><a href="dept-edit.jsp?group=<%= URLEncoder.encode(group.getName(), "UTF-8")%>"><%= group.getName() %></a></b>
<fmt:message key="group.delete.hint_info1" />
</p>

<form action="dept-delete.jsp">
