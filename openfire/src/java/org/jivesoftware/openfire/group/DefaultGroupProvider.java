...
public class DefaultGroupProvider extends AbstractGroupProvider {
    ...
    private static final String ALL_GROUPS = "SELECT groupName FROM ofGroup ORDER BY description asc ";
    private static final String SEARCH_GROUP_NAME = "SELECT groupName FROM ofGroup WHERE groupName LIKE ? ORDER BY description asc ";
